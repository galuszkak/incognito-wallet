...
export const setToken = (token = new Error('Token object is required')) => ({
  type: type.SET,
  data: token,
});

export const removeTokenById = (
  tokenId = new Error('Token id is required'),
) => ({
 ...
 */
export const setListToken = (tokens = new Error('Token list is required')) => {
 ...
 * Replace with new list
 */
export const setListPToken = (tokens = new Error('Token list is required')) => {
  if (tokens && tokens.constructor !== Array) {
    throw new TypeError('Tokens must be an array');
  }
...
export const setListInternalToken = (
  tokens = new Error('Token list is required'),
) => {
  if (tokens && tokens.constructor !== Array) {
    throw new TypeError('Tokens must be an array');
  }
...
export const setBulkToken = (tokens = new Error('Token array is required')) => {
  if (tokens && tokens.constructor !== Array) {
    throw new TypeError('Tokens must be an array');
  }
...
export const getBalance = (
  token = new Error('Token object is required'),
